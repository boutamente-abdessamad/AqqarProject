            ...
            <div class="container">
                <div class="row">
                  ...
                  <div class="panel panel-default panel-form body-panel-style">
                        ...
                        <h5 class="h3"><b>إملأ معلومات عقارك</b></h5>
                        </div>
                        <div class="panel-body ">
                           <form action="">   
                              <div class="contant-center">
                                <div class="col-md-6 left-form">    
                                    <label for="type" class="align-items">عنوان العرض</label>
                                    <input type="text" class="form-control">
                                    <label for="type" class="align-items">الوصف التفصيلي</label>
                                  ...
                                  <div class="col-md-6">
                                    ...
                                    <div >
                                        ...
                                        <div>
                                            <label for="type" class="align-items">الغرض</label>
                                            <select  name="type" id="type" class="form-control">
                                                <option value="1">البيع</option>
                                                <option value="1">الإيجار</option>
                                            </select>
                                        </div>
                                        <div >
                                        ...
                                        <div >
                                            <label for="type" class=" price-style">عدد الحمامات</label><br>
                                            <input class="form-control" type="number" placeholder="1">
                                        </div>
                                        <div >
                                            <label for="type" class=" price-style">الطابق</label><br>
                                            <input class="form-control" type="number" placeholder="1">
                                        </div>
                                        <div>
                                            ...
                                            <div>
                                            <input type="checkbox" class="check-style" >قابل للتفاوض
                                            </div>
                                        </div>
                                        <div >   
                                        </div>
                                        <div >
                                            <label for="type" class=" price-style">الهاتف</label><br>
                                            <input type="phone" class="form-control" placeholder="0-00-00-00-00">
                                        </div>
                                        <div>
                                            <label for="type" >البريد الإلكتروني</label>
